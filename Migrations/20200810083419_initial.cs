    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            Id = table.Column<int>(nullable: false)
                  .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
            Person_IdentityNumber = table.Column<string>(nullable: true),
            Person_FullName = table.Column<string>(nullable: true),
            Person_FirstName = table.Column<string>(nullable: true),
            Person_LastName = table.Column<string>(nullable: true),
            Person_DisplayName = table.Column<string>(nullable: true),
            Person_Address = table.Column<string>(nullable: true),
            Person_Phone = table.Column<string>(nullable: true),
            Person_Email = table.Column<string>(nullable: true),
            Person_Birthday = table.Column<DateTime>(nullable: true),
